...
* From the Open File or Project window that appears, navigate to and select the aloko001/speech_recognizer/android directory from wherever you cloned the TensorFlow Lite sample GitHub repo. Click OK.
